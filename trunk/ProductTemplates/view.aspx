<%@ Page Language="c#" MasterPageFile="~/DefaultView.Master" Inherits="CRM.InvoiceManagement.ProductTemplates.View"
    CodeBehind="view.aspx.cs" %>

<%@ Register TagPrefix="CRM" TagName="Shortcuts" Src="~/CRM/UserControls/Shortcuts.ascx" %>
<%@ Register TagPrefix="CRM" TagName="DetailView" Src="~/CRM/Invoice Management/ProductTemplates/UserControls/DetailView.ascx" %>
