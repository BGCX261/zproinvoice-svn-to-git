<%@ Page Language="c#" MasterPageFile="~/PopupView.Master" Inherits="CRM.InvoiceManagement.Products.Popup" Codebehind="Popup.aspx.cs" %>
...
{
	if ( p != null && p.ChangeProduct != null )
	{
		p.ChangeProduct(sPARENT_ID, sPARENT_NAME);
		window.close();
	}
	else
	{
...
function Cancel()
{
    ...
    <CRM:ListHeader Title="Products.LBL_LIST_FORM_TITLE" runat="Server" />
