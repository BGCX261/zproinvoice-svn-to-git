<%@ Control Language="c#" Inherits="CRM.InvoiceManagement.ProductCategories.ListView" Codebehind="ListView.ascx.cs" %>
...
<div id="divListView">
    ...
    <CRM:ExportHeader ID="ctlExportHeader" Module="ProductCategories" Title="ProductCategories.LBL_LIST_FORM_TITLE"
        runat="Server" />
    <asp:Panel CssClass="button-panel" Visible="<%# !PrintView %>" runat="server">
        <asp:Button ID="btnCreate" CommandName="ProductCategories.Create" OnCommand="Page_Command"
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
        <ContentTemplate>
            <CRM:CRMGrid GridLines="None" ID="grdMain" AllowPaging="false" AllowSorting="true"
                ...
                <Columns>
                    <asp:TemplateColumn HeaderText="ProductCategories.LBL_LIST_NAME" SortExpression="NAME"
                    ...
                    <asp:BoundColumn HeaderText="ProductCategories.LBL_LIST_DESCRIPTION" DataField="DESCRIPTION"
                        SortExpression="DESCRIPTION" ItemStyle-Width="55%" />
                    <asp:BoundColumn HeaderText="ProductCategories.LBL_LIST_ORDER" DataField="LIST_ORDER"
                    ...
                    <asp:TemplateColumn HeaderText="" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Left"
                        ...
                        <ItemTemplate>
                            <span onclick="return confirm('<%= Translation.GetTranslation.Term(".NTC_DELETE_CONFIRMATION") %>')">
                                <asp:ImageButton CommandName="ProductCategories.Delete" CommandArgument='<%# Eval( "ID") %>'
                                ...
                                <asp:LinkButton CommandName="ProductCategories.Delete" CommandArgument='<%# Eval( "ID") %>'
